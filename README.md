...
- 五行起步的无限元素合成玩法，支持缓存命中与新的 AI 合成
- 无限工作台，支持拖拽、缩放、平移、重叠合成与清空
- 图鉴、配方表、合成树弹窗，方便回看探索进度
- 移动端底部元素面板，提供更紧凑的搜索、排序和分类筛选
- 合成成功 / 新发现提示音，且可在设置中一键开关
- 设置页支持模型配置、数据导入导出、重置进度与作者主页入口
